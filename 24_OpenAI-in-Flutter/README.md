# Summary Open AI Flutter


##### 1. Open AI sebuah library yang dapat digunakan untuk memanfaatkan (Artificial Intelgence) yang disediakan OpenAI keuntungan OpenAI - Gratis,Mudah dipasang, dapat digunakan di berbagai perangkat


##### 2. Mengakses OpenAI dan Juga mendapatkan API Key 
###### Mendaftar di situs web OpenAI: Kunjungi situs web OpenAI (https://openai.com) dan buat akun pengguna 

###### Masuk ke Dashboard pilih menu APIKeys kemudian create new scret key dan masukan nama scret key kemudian dapat API key simpan di tempat aman

##### 3. Membuat project memanfaatkan OPEN AI
```dart
