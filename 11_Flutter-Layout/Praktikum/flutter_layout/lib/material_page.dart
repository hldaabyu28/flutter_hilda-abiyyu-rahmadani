  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar (
        ...
        centerTitle: true,
        backgroundColor: Color.fromARGB(255, 90, 86, 94),
      ),
      drawer: Drawer(
        child: ListView(
          children: <Widget>[
      ...
      bottomNavigationBar: BottomNavigationBar(
        selectedItemColor: const Color.fromARGB(255, 117, 255, 133),
        backgroundColor: const Color.fromARGB(255, 90, 86, 94),
        items: const [
          BottomNavigationBarItem(icon: Icon(Icons.home, color: Color.fromARGB(255, 117, 255, 133),), label: 'Home' ),
